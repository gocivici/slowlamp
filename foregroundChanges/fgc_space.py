...
class Trace:
    def __init__(self, main_color, count = 5, traces_storing_mode="single", supplemental_colors=None, supplemental_counts=None):
...
#-------------------------Backgorund Substraction-----------------------------------
    ...
    if len(imgNoB.flatten()) <= 10: #needs to be greater than K
        ...
        trace = Trace(vibrant_color, count = 0, traces_storing_mode="vaooo", supplemental_colors=[largest_color]*4, supplemental_counts = [0]*4)
