...
#-------------------------Backgorund Substraction-----------------------------------
    ...
    return (largest_color, lg_count), (expressible_color, 0), (vibrant_color, vr_count), (cluster_color, 0), time_elapsed
...
time_elapsed = 0 
while True:
    largest_color, expressible_color, vibrant_color, cluster_color, time_elapsed = dominantColor(day_length*60-time_elapsed) #time in seconds
