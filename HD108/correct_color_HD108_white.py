...
def init(data_folder): 
    ...
    model_name = 'hd108_white_model_relu.pkl'
    if not os.path.exists(model_name):
        ...
        data = np.load(data_folder+"pairings-32-white_HD108_877_with_light.npz")
        ...
        input_rgbs = np.concatenate([gamma_input_rgbs])
        observed_rgbs = np.concatenate([gamma_observed_rgbs])
...
if __name__ == "__main__":
    ...
    init("/home/slowlamp4/Documents/slowlamp/")
